...
class TyreShop extends StatefulWidget {
  const TyreShop({Key key}) : super(key: key);

  @override
  _TyreShopState createState() => _TyreShopState();
}

class _TyreShopState extends State<TyreShop> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Tyre Shops"),
...
class _ListState extends State<List> {
  ...
  Future getCarGarages() async {
    ...
    QuerySnapshot qn = await db.collection("provider").where("SerCat", isEqualTo: "Tyre shop").get();
    return qn.docs;
  }
