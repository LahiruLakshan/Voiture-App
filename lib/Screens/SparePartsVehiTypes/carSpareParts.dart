...
class CarSpareParts extends StatefulWidget {
  const CarSpareParts({Key key}) : super(key: key);

  @override
  _CarSparePartsState createState() => _CarSparePartsState();
}

class _CarSparePartsState extends State<CarSpareParts> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Car Spare Parts"),
...
class _ListState extends State<List> {
  ...
  Future getCarGarages() async {
    ...
    QuerySnapshot qn = await db.collection("provider").where("SerCat", isEqualTo: "Spare parts").where("VehiType", isEqualTo: "Car").get();
    return qn.docs;
  }
