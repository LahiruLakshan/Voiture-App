...
class ThreeWheelSpareParts extends StatefulWidget {
  const ThreeWheelSpareParts({Key key}) : super(key: key);

  @override
  _ThreeWheelSparePartsState createState() => _ThreeWheelSparePartsState();
}

class _ThreeWheelSparePartsState extends State<ThreeWheelSpareParts> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Three Wheel Spare Parts"),
...
class _ListState extends State<List> {
  ...
  Future getCarGarages() async {
    ...
    QuerySnapshot qn = await db.collection("provider").where("SerCat", isEqualTo: "Spare parts").where("VehiType", isEqualTo: "Threewheel").get();
    return qn.docs;
  }
