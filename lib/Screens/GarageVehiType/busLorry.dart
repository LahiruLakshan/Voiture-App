...
class BusLorry extends StatefulWidget {
  const BusLorry({Key key}) : super(key: key);

  @override
  _BusLorryState createState() => _BusLorryState();
}

class _BusLorryState extends State<BusLorry> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Bus/Lorry Garages"),
...
class _ListState extends State<List> {
  ...
  Future getCarGarages() async {
    ...
    QuerySnapshot qn = await db.collection("provider").where("SerCat", isEqualTo: "Garage").where("VehiType", isEqualTo: "Bus / Lorry").get();
    return qn.docs;
  }
