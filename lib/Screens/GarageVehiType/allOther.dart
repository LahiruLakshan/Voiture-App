...
class AllOther extends StatefulWidget {
  const AllOther({Key key}) : super(key: key);

  @override
  _AllOtherState createState() => _AllOtherState();
}

class _AllOtherState extends State<AllOther> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("All other Garages"),
...
class _ListState extends State<List> {
  ...
  Future getCarGarages() async {
    ...
    QuerySnapshot qn = await db.collection("provider").where("SerCat", isEqualTo: "Garage").where("VehiType", isEqualTo: "All").get();
    return qn.docs;
  }
